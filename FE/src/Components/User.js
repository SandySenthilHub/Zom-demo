...
class User extends Component {
    ...
    signupFormApiCall = async () => {
        ...
        const result = await axios({
            method: 'POST',
            url: 'http://localhost:9876/signup',
            ...
            <div>
                ...
                >
                    ...
                    <div className="container-login">
                        ...
                        <div className="wrap-login">
                            <button className="login-close" onClick={this.closeModal}><Icon.BackspaceFill/> </button>
                            ...
                            <div>
                                ...
                                clientId='161085522923-n2ris2lfs81hb6dd262rmdadtv2pevrm.apps.googleusercontent.com'
                                    ...
                                    render={renderProps => (
                                        <button className="google-auth-button" onClick={renderProps.onClick} disabled={renderProps.disabled}><img src="https://colorlib.com/etc/lf/Login_v5/images/icons/icon-google.png" /> Login with Google</button>
                                    )}
                            ...
                            <form className="login-form" onSubmit={this.handleLogin}>
                                ...
                                <div class="wrap-input100 validate-input alert-validate" data-validate="Username is required">
                                    <input id='loginField' class="input100 form-control" type="email" name="email" placeholder="Email" onChange={this.handleLoginFields} required />
                                </div>
                                <div class="wrap-input100 validate-input alert-validate" data-validate="Username is required">
                                    <input id='loginField' class="input100 form-control" type="password" name="password" placeholder="Password" onChange={this.handleLoginFields} required />
                                </div>
                                <div style={{ marginTop: '17px' }}>
                                    <button className="login-submit" disabled={loading}>{loading ? <Icon.ArrowClockwise/> : <i ></i>}Sign In</button>
                                </div>
                                <div style={{ marginTop: '17px', fontSize: '16px', textAlign: 'center' , color:'white'}}>Don't have an account? <a href="#" onClick={this.switchToSignup}>Sign up now</a></div>
                            </form>
                        </div>
                    </div>
                ...
                >
                    ...
                    <div className="container-login">
                        ...
                        <div className="wrap-login">
                            <button className="login-close" onClick={this.closeSignupModal}><Icon.BackspaceFill/></button>
                            <form className="login-form" onSubmit={this.handleSignupForm}>
                                ...
                                <div class="wrap-input100 validate-input alert-validate" data-validate="Username is required">
                                    <input id='signField' style={{marginTop:'25px'}} class="input100 form-control" type="text" name="username" onChange={this.handlesSignupFields} placeholder="Full Name" required />
                                </div>
                                <div class="wrap-input100 validate-input alert-validate" data-validate="Username is required">
                                    <input id='signField' class="input100 form-control" type="email" name="email" onChange={this.handlesSignupFields} placeholder="Email" required />
                                </div>
                                <div class="wrap-input100 validate-input alert-validate" data-validate="Username is required">
                                    <input id='signField' class="input100 form-control" type="password" name="password" onChange={this.handlesSignupFields} placeholder="Password" minlength="8" required />
                                </div>
                                <div class="wrap-input100 validate-input alert-validate" data-validate="Username is required">
                                    <input id='signField' class="input100 form-control" type="password" name="confirmPassword" onChange={this.handlesSignupFields} placeholder="Confirm Password" minlength="8" required />
                                </div>
                                <div style={{ marginTop: '17px' }}>
                                    <button type="submit" className="sign-submit" disabled={loading}>{loading ? <Icon.ArrowClockwise/> : <i ></i>}Create account</button>
                                </div>
                                <div style={{ marginTop: '17px', fontSize: '16px', textAlign: 'center', color:'white' }}>Already have an account? <a href="#" onClick={this.switchToSignin}>Sign in now</a></div>
                            </form>
                        </div>
                    </div>

...
class Filter extends React.Component {
    ...
    componentDidMount = async () => {
        ...
        const restuarant = await axios({
            method: 'POST',
            url: 'http://localhost:9876/filter',
    ...
    render() {
        ...
        let result = currentRestuarant && currentRestuarant.length > 0 ? currentRestuarant.map((item) => {
            return  <div className="box" onClick={() => this.handleViewRestaurant(item._id)}>
            <div className="Itembox">
                {/* <div className="restaurant-box"> */}
                <div style={{ display: "inline-block" }}>

                    <img className="filterImage" src={item.thumb} alt="breakfast" />

                </div>
                <div style={{ display: "inline-block", lineHeight: "10px", verticalAlign: 'top', margin: '1rem 0 0 1rem' }} className="res-details">
                    <h2 className="mealName"> {item.name} </h2>
                    <h4 className="mealLoc">{item.locality}</h4>
                    <h5 style={{ fontSize: "20px", width: "auto", marginTop: "10px", lineHeight: "20px", color: '#636f88' }}>{item.address}</h5>
                </div>
                <hr />
                <div style={{ display: "inline-block", marginTop: "1px", marginLeft: "10px" }}>
                    <h4 className="cuisine" style={{ color: '#636f88' }}>CUISINES :</h4>
                    <h4 className="cost" style={{ color: '#636f88' }}>COST FOR TWO :</h4>
                </div>
                <div style={{ display: "inline-block", verticalAlign: "top", marginTop: "1px", marginLeft: "10px", marginBottom: '10px' }}>
                    <h4 className="cuisine" style={{ color: '#192f60' }}>{item.cuisine_id.map((cuis) => cuis.name + " ")}</h4>
                    <h4 className="cost" style={{ color: '#192f60', marginBottom: '10px' }}>₹{item.cost}</h4>
                </div>
                </div>
            </div>
        ...
        if (currentPage === 1 && pageNumbers.length > 1) {
            prevButton = <li className="page-list disabled"><a className="page-numbers"  id='pgno'>{`<`}</a></li>
        }
        ...
        if (pageNumbers.length > 1) {
            nextButton = <li className="page-list"><a href="#" className="page-numbers" id='pgno2' onClick={this.handleNext}>{`>`}</a></li>
        }
        if (currentPage === pageNumbers.length && pageNumbers.length > 1) {
            nextButton = <li className="page-list disabled"><a className="page-numbers"  id='pgno2'>{`>`}</a></li>
        }
            ...
            return (
                <div className=''>
                    <li key={number} className="page-list">
                        <a className="page-numbers" style={currentPage === number ? {} : {}} href="#" id={number} onClick={this.handleClickPage}>{number}</a>
                    </li>
                </div>
        ...
        return (
            <React.Fragment>
                <div style={{  position: "absolute", height: "1000px", width: "100%" }}>
                    ...
                    <div className="container1" style={{ marginTop: "2%" }}>
                        ...
                        <h1 className="filter-heading" style={{ fontWeight: 'bolder', fontSize: '25px', marginLeft: '20px' }}>{this.state.option} Places in New Delhi</h1>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-4">
                                <div className="panel panel-default" style={{ padding: '15px', marginBottom: '10px' }}>
                                    <h4 className="filter" style={{ fontWeight: 'bolder', fontSize: '30px', marginLeft: '20px' }}>Filters / Sort</h4>
                                ...
                                <div className="filterRight" id="demo"  >
                                    <h4 style={{ fontWeight: "600", fontSize: '32px' }}>Filters</h4>
                                    <div style={{ fontSize: '25px', marginBottom: '25px' }}>Select location</div>


                                    {/* This is for locations drop-down menu */}
                                    <div className="form-group">
                                        <select style={{ padding: '8px' }} className="drop-down" onChange={this.handleLocationChange}>
                                            <option selected disabled>Select Your Locations</option>
                                    ...
                                    <div style={{ fontWeight: "600", fontSize: '22px', marginTop: '30px', color: '#192f60' }}>Cuisine</div>
                                    <div className="checkbox">
                                        <label style={{ width: '500px' }} > <input type="checkbox" onChange={() => this.handleCuisineChange(1)} />  North-Indian</label>
                                    </div>
                                    <div className="checkbox">
                                        <label style={{ width: '500px' }}><input type="checkbox" onChange={() => this.handleCuisineChange(2)} />  South-Indian</label>
                                    </div>
                                    <div className="checkbox">
                                        <label style={{ width: '500px' }}><input type="checkbox" onChange={() => this.handleCuisineChange(3)} />  Chinese</label>
                                    </div>
                                    <div className="checkbox">
                                        <label style={{ width: '500px' }}><input type="checkbox" onChange={() => this.handleCuisineChange(4)} />  Fast Food</label>
                                    </div>
                                    <div className="checkbox">
                                        <label style={{ width: '500px' }}><input type="checkbox" onChange={() => this.handleCuisineChange(5)} />  Street Food</label>
                                    </div>


                                    {/* This is for cost for tow radio box. */}
                                    <div style={{ fontWeight: "600", fontSize: '22px', marginTop: '30px', color: '#192f60' }}>Cost for two</div>
                                    <div className="radio">
                                    ...
                                    <div style={{ fontWeight: "600", fontSize: '22px', marginTop: '0px', color: '#192f60' }}>Sort</div>
                                    <div className="radio">
...
//         let result = currentRestuarant && currentRestuarant.length > 0 ? currentRestuarant.map((item) => {
//             return <div className="box" onClick={() => this.handleViewRestaurant(item._id)}>
//                 <div className="restaurant-box" style={{boxShadow: "2px 1px 10px 2px black", height:"290px",margin: "0 0 20px 0" }}>
//                     <div style={{ display: "inline-block" }}>
//                         <img className="filter-image" src={item.thumb} width="120" height="120" alt="breakfast"
//                             style={{ borderRadius: "25px", margin: "20px" }} />
//                     </div>
//                     <div style={{ display: "inline-block", lineHeight:"10px",verticalAlign: 'top', margin: '1rem 0 0 1rem' }} className="res-details">
//                         <h2 style={{ fontSize:"30px",fontWeight: "600", color: '#192f60' }}> {item.name} </h2>
//                         <h4 style={{ fontSize:"27px",fontWeight: "600", marginTop: "10px", color: '#192f60' }}>{item.locality}</h4>
//                         <h5 style={{ fontSize:"20px",width: "35rem", marginTop: "10px",lineHeight:"10px", color: '#636f88' }}>{item.address}</h5>
//                     </div>
//                     <hr />
//                     <div style={{ display: "inline-block", marginTop: "1px", marginLeft:"10px" }}>
...
//                     </div>
//                     <div style={{ display: "inline-block", verticalAlign: "top", marginTop: "1px",marginLeft:"10px" }}>
...
//         return (
//             <React.Fragment>
//                 <div style={{backgroundColor:"rgb(128, 128, 128, 0.6)", position:"absolute", height:"1000px", width:"100%"}}>
//                 {/* <img src="assets/filter.jpg"/> */}
//                 {/* This is for navigation bar */}
//                 {/* <Navbar/> */}
//                 <div className="container1" style={{ marginTop: "2%" }}>
...
//                     <h1 className="filter-heading" >{this.state.option} Places in New Delhi</h1>
...
//                         <div className="col-md-4">
//                             <div className="panel panel-default" style={{ padding: '15px', marginBottom: '0px' , width:'100%'}}>
//                                 <h4 className="filter">Filters / Sort</h4>
//                                 <div style={{ display: "inline-block", verticalAlign: "top" }}
//                                     className="glyphicon glyphicon-chevron-down toggle-div" data-toggle="collapse" data-target="#demo">
//                                 </div>
//                             </div>
...
//                             {/* This is the right side block which contains all filter options */}
//                             <div style={{lineHeight:"25px", width:"17%",boxShadow: "2px 1px 10px 2px black", height: "auto", padding: '17px 25px 31px 26px', marginTop: "-50px",marginLeft:"-20px", background: "#fff" }} id="demo" className="collapse show" >
//                                 <h4 style={{ fontWeight: "600", fontSize: '22px', marginTop: '10px' }}>Filters</h4>
//                                 <div style={{ fontSize: '20px' }}>Select location</div>
...
//                                 {/* This is a cuisine checkbox */}
//                                 <div style={{ fontWeight: "normal", fontSize: '22px', marginTop: '30px', color: '#192f60' }}>Cuisine</div>
//                                 <div className="checkbox">
...
//                                 {/* This is for cost for tow radio box. */}
//                                 <div style={{ fontWeight: "normal", fontSize: '22px', marginTop: '30px', color: '#192f60' }}>Cost for two</div>
//                                 <div className="radio">
//                                     <label><input type="radio" name="cost" onChange={() => this.handleCost(1, 500)} />Less than ₹500</label>
//                                 </div>
//                                 <div className="radio">
...
//                                 {/* This is for sort options. */}
//                                 <div style={{ fontWeight: "600", fontSize: '22px', marginTop: '10px', color: '#192f60' }}>Sort</div>
//                                 <div className="radio">
//                                     <label><input type="radio" name="sort" onChange={() => this.handleSort(1)} />Price low to high</label>
//                                 </div>
//                                 <div className="radio">
